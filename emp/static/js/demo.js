(function($) {
    var app=$.sammy(function() {
        ...
        this.get('#/', function(context) {
            context.log('HomePage of Employee Information Syatem');
            $("#main").load('/emp/index/');
         });
                     ...
                     success: function (data) {
                         ...
                         $.each(data,function(key,value){
                             ...
                             $("#department_list").append( "<tr id="+value.department_id+">"+
                                 ...
                                 "<td>"+ "<a class=\"view btn\" id="+value.department_id+" name="+value.department_name+" href=\"#/view_details/"+value.department_id+"/"+value.department_name+"/\">View Details</a>" +"</td>"+
